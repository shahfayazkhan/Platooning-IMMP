            ...
            public void run(){
                for(i=x; i<= s; i++){
                    ...
                    if(i==s){
                       ...
                       /* if(Change_Cars_Position_2.C2JoinPosition == 2){
                            PC2(l2,l4);
                        }else if(Change_Cars_Position_2.C2JoinPosition == 3){
                            PC3(l2,l4);
                        }else if(Change_Cars_Position_2.C2JoinPosition == 4){
                            PC4(l2,l4);
                        }else if(Change_Cars_Position_2.C2JoinPosition == 5){
                            PC5(l2,l4);
                        }else if(Change_Cars_Position_2.C2JoinPosition == 6){
                            PC6(l2,l4);
                        }else if(Change_Cars_Position_2.C2JoinPosition == 7){
                            PC7(l2,l4);
                        }*/
                    }
                }
