...
public class Change_Cars_Position_2 {
    
    public Thread c1,t2,t3,c1lea;
    double cl1y;
    double cl2x;
    int tm,rsu,ch;
    public static int C2JoinPosition;
    ...
    public void speedControl(JLabel l1,JLabel l2,int spd,int s,JLabel join){
        ...
        t3 = new Thread(){
            public void run(){
                for(double i=x;i<=s;i++){
                    ...
                    if(join.getText().equals("Processing...?")){
                    l1.setLocation((int)l2.getLocation().getX()-50,(int)y);
                    }else{
    ...
    public void Permission(JLabel l1,JLabel l2,int w,JLabel l3,JLabel l4,int spd,
        ...
        try{
            ...
            if(tm==2){
                ...
                C2JoinPosition = Integer.parseInt(l4.getText());
                proc.setText("Accepted...?");
                C2Position(l1,l2,w,spd,proc,l4,light);
                }else{
                ...
                + "Thank you For using Platooning...?<br></html>");
                    ...
                    Main_Form.model.addRow(new Object[]{l1.getText(),"P",
                        l4.getText(),"5",l1.getText(),l1.getLocation().getX()
                        ...
                        dbdata.InsertData("Joining", conn, "P", l4.getText(),
                                "5", l1.getText(), l1.getLocation().getX(),
                                Main_Form.tspeed, Setup.txtspeed.getText(),
                                Setup.txtspeed.getText(), "Joining", "Failed", time, date);
                        
                    
                    //Main_Form.C2Run.addC1(l1,l2, w, spd,l4);
                    //t2.stop();
                }
                t3.stop();
                t2.stop();
    ...
    public void C2Position(JLabel l1,JLabel l2,int w,int spd,JLabel proc,JLabel l4,
            JLabel lt){
    ...
    public void JoinArray(JLabel l1){
        ...
        Main_Form.PlatoonArray.add(2,Integer.parseInt(l1.getText()));
        }else{
        Main_Form.PlatoonArray.add(4, Integer.parseInt(l1.getText()));
        }
        Main_Form.CarsSelectingArray.remove(0);
    }
            ...
            public void run(){
                for(;;){
                    ...
                    if(cl11y > 65.0){
                        ...
                        Main_Form.c2r = "";
                        lv.setText("Waiting...?");
                        Main_Form.C2Run.addC1(l1,l2, w, 10);
                        if(Setup.Operation.equals("Multiple")){
                        Main_Form.MultipleisDone = "Finish";
                        }
